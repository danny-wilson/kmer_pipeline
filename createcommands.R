...
if(length(args)>2){
	...
	cat("Using default test files","\n")
	prefix="saur_fusacid_test12"
	id_file="/well/bag/earle/Saureus/ares992/saur_992_fusidicacid_12isolates_id_path_pheno.txt"
	analysis_file="/well/bag/earle/Saureus/ares992/analysistype_nucleotide31_protein11.txt"
	ref_fa="/well/bag/earle/Saureus/ares992/ref/R00000022.fa"
	ref_gb="/well/bag/earle/Saureus/ares992/ref/R00000022.gbk"
